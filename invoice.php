				...
				<div class="invoice-box">
					...
					<div class="row pb-30">
						<div class="col-md-6">
							...
							<p class="font-14 mb-5">Lab Name: <strong class="weight-600">4556</strong></p>
							<p class="font-14 mb-5">Partner: <strong class="weight-600">4556</strong></p>
							<p class="font-14 mb-5">Client Code: <strong class="weight-600">4556</strong></p>
							<p class="font-14 mb-5">Contact No.: <strong class="weight-600">4556</strong></p>

						</div>
						<div class="col-md-6">
							<div class="text-right">
								<p class="font-14 mb-5">Patient ID: <strong class="weight-600">10 Jan 2018</strong></p>
								<p class="font-14 mb-5">Name: <strong class="weight-600">10 Jan 2018</strong></p>
								<p class="font-14 mb-5">Age: <strong class="weight-600">10 Jan 2018</strong></p>
								<p class="font-14 mb-5">Gender: <strong class="weight-600">10 Jan 2018</strong></p>
							</div>
						</div>
					</div>
